...
```text
Panyakorns-MacBook-Pro:server panyakornlohaviboonsap$ npm run test

> toktickit-server@1.0.0 test
> vitest run

 RUN  v2.1.9 /Users/panyakornlohaviboonsap/Documents/KMUTT/Year 3/Software Engineering/Lab/toktickit/server
...
RUN  v2.1.9 /Users/panyakornlohaviboonsap/Documents/KMUTT/Year 3/Software Engineering/Lab/toktickit/client
